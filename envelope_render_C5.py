...
def render_C5(canv, letter_info, from_info):
    ...
    textlines = [
        # from
        {"x": 10, "y": 110, "w": 15, "h": 15, "fontsize": 10, "font": "TimesNewRomanBold", "alignment": TA_LEFT,
         "text": u"От кого:"},
        {"x": 25, "y": 110, "w": 70, "h": 15, "fontsize": 10, "font": "TimesNewRoman", "alignment": TA_LEFT,
         "text": from_name},
        {"x": 10, "y": 98, "w": 15, "h": 15, "fontsize": 10, "font": "TimesNewRomanBold", "alignment": TA_LEFT,
         "text": u"Откуда:"},
        {"x": 25, "y": 98, "w": 70, "h": 15, "fontsize": 10, "font": "TimesNewRoman", "alignment": TA_LEFT,
         "text": from_addr},
        {"x": 10, "y": 86, "w": 65, "h": 15, "fontsize": 14, "font": "TimesNewRomanBold", "alignment": TA_LEFT,
         "text": from_index},
        {"x": 10, "y": 35, "w": 30, "h": 15, "fontsize": 10, "font": "TimesNewRoman", "alignment": TA_LEFT,
         "text": from_fio},
        {"x": 10, "y": 45, "w": 55, "h": 25, "fontsize": 14, "font": "TimesNewRomanBold", "alignment": TA_CENTER,
         "text": no_return, "border": True},
        # to
        {"x": 115, "y": 50, "w": 15, "h": 15, "fontsize": 10, "font": "TimesNewRomanBold", "alignment": TA_LEFT,
         "text": u"Кому:"},
        {"x": 130, "y": 50, "w": 85, "h": 15, "fontsize": 10, "font": "TimesNewRoman", "alignment": TA_LEFT,
         "text": dst_name},
        {"x": 115, "y": 35, "w": 15, "h": 15, "fontsize": 10, "font": "TimesNewRomanBold", "alignment": TA_LEFT,
         "text": u"Куда:"},
        {"x": 130, "y": 35, "w": 85, "h": 20, "fontsize": 10, "font": "TimesNewRoman", "alignment": TA_LEFT,
         "text": dst_addr},
        {"x": 185, "y": 20, "w": 25, "h": 5, "fontsize": 16, "font": "TimesNewRomanBold", "alignment": TA_LEFT,
         "text": dst_index},
        # barcode
        ...
        # letter category etc
        {"x": 115, "y": 112, "w": 45, "h": 15, "fontsize": 10, "font": "TimesNewRomanBold", "alignment": TA_LEFT,
         "text": u"Без разряда"},
        {"x": 115, "y": 105, "w": 85, "h": 15, "fontsize": 10, "font": "TimesNewRoman", "alignment": TA_LEFT,
         "text": u"Вес: %dг" % (mass,)},
        {"x": 115, "y": 100, "w": 85, "h": 15, "fontsize": 10, "font": "TimesNewRoman", "alignment": TA_LEFT,
    ...
    if "mail-category" in letter_info:
        ...
        textlines.append({"x": 115, "y": 116, "w": 45, "h": 15, "fontsize": 10, "font": "TimesNewRomanBold",
...
def render_QR(canv, letter_info, from_info, x, y):
    ...
    textlines = [
        {"x": 33, "y": 20, "w": 35, "h": 15, "fontsize": 11, "font": "TimesNewRoman", "alignment": TA_CENTER,
         "text": "РОССИЯ•RUSSIA"},
        {"x": 33, "y": 16, "w": 35, "h": 15, "fontsize": 11, "font": "TimesNewRoman", "alignment": TA_CENTER,
         "text": "ПОЧТА"},
        {"x": 33, "y": 13, "w": 35, "h": 20, "fontsize": 20, "font": "TimesNewRoman", "alignment": TA_LEFT,
         "text": "₽"},
        {"x": 33, "y": 11, "w": 35, "h": 15, "fontsize": 14, "font": "TimesNewRoman", "alignment": TA_CENTER,
         "text": opm_value_print},
        {"x": 33, "y": 6, "w": 35, "h": 15, "fontsize": 9, "font": "TimesNewRoman", "alignment": TA_LEFT,
         "text": date_oper.strftime("%d/%m/%Y")},
        {"x": 33, "y": 6, "w": 35, "h": 15, "fontsize": 9, "font": "TimesNewRoman", "alignment": TA_RIGHT,
         "text": opm_index_oper},
        {"x": 33, "y": 2, "w": 35, "h": 15, "fontsize": 9, "font": "TimesNewRoman", "alignment": TA_LEFT,
         "text": opm_id},
    ]
    for i in textlines:
        ps = getSampleStyleSheet()["Normal"]
